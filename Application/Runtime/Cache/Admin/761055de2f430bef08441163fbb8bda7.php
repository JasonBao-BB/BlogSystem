   ...
   <div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">Home Page</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">Link Management</a><span class="crumb-step">&gt;</span><span>Edit Article</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/blog/index.php/Article/edit" method="post" id="myform" name="myform" enctype="multipart/form-data">
                        ...
                        <tbody>
                           ...
                           <!-- Input Description -->
                             <tr>
                                ...
                                <td>
                                    <textarea class="common-text required" name="article_desc" style="width: 300px; height: 50px;"><?php echo ($articles["article_desc"]); ?></textarea>
                                </td>
                            </tr>
                            <!-- Input Picture -->
                             <tr>
                                ...
                                <td>
                                    ...
                                    <!-- If Image Show or Not -->
                                    <?php if($articles['pic'] != ''): ?><img src="/blog<?php echo ($articles["pic"]); ?>" height="50" width="50">
                                    <?php else: ?>
                                    No Image<?php endif; ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                     <textarea id="container" name="content"><?php echo ($articles["content"]); ?></textarea>
...
<script type="text/javascript">
        var ue = UE.getEditor('container',{initialFrameWidth:1300,initialFrameHeight:400,});
</script>
