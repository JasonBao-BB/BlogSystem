   ...
   <div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">Home Page</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">Admin Management</a><span class="crumb-step">&gt;</span><span>Add Admin</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/blog/index.php/Admin/Admin/add" method="post" id="myform" name="myform">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>Admin Name:</th>
                                <td>
                            ...
                            <tr>
                                <th><i class="require-red">*</i>Admin Password:</th>
                                <td>
                            ...
                            <tr>
                                <th><i class="require-red">*</i>Admin Repassword:</th>
                                <td>
